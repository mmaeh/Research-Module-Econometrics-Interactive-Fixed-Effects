...
for (c in combinations) {
  ...
  for (rep in 1:n_rep) {
    ...
    source('./mc_simulations/data_generating/data_generating_generak.R')
...
# Save results table.
saveRDS(results, './mc_simulations/output/table_factor_dim.rds')
write.csv(results, './mc_simulations/output/table_factor_dim.csv')
