...
for (c in combinations) {
  ...
  for (rep in 1:n_rep) {
    ...
    source('./mc_simulations/data_generating/data_generating_unit_root.R')
...
# Save results.
saveRDS(results, './mc_simulations/output/table_unit_root.rds')
write.csv(results, './mc_simulations/output/table_unit_root.csv')
