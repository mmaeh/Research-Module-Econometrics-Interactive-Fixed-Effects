...
data_weighted['fctr_str_dim3_bai'] <- as.vector(ife_clmn4$unob.fact.stru)

# Plot factor structure.
ggplot(data = data_weighted, aes(x = year, y = fctr_str_dim3_bai, group = Sector, linetype = code_1, color = code_1, shape = code_1)) + 
  geom_line(size = 1.5) +
  geom_point(size = 3) + 
...
# Save figure.
ggsave("./data_application/figures/output/03_fctstr_fdim3_bai.png", dpi = 600, width = 20, height = 20)
...
# Get factor structure to dataframe.
data_weighted['fctr_str_dim3_kneip'] <- as.vector(ife_clmn4$unob.fact.stru)

# Plot factor structure.
ggplot(data = data_weighted, aes(x = year, y = fctr_str_dim3_kneip, group = Sector, linetype = code_1, color = code_1, shape = code_1)) + 
  geom_line(size = 1.5) +
  geom_point(size = 3) + 
  scale_colour_manual(values = col_vector, labels = name_vector) + 
  scale_linetype_manual(values = line_vector, labels = name_vector) + 
...
# Save figure.
ggsave("./data_application/figures/output/A2_fctstr_fdim3_kneip.png", dpi = 600, width = 20, height = 20)
...
# Get factor structure to dataframe.
data_weighted['fctr_str_dim2_kneip'] <- as.vector(ife_clmn4$unob.fact.stru)

# Plot factor structure.
ggplot(data = data_weighted, aes(x = year, y = fctr_str_dim2_kneip, group = Sector, linetype = code_1, color = code_1, shape = code_1)) + 
  geom_line(size = 1.5) +
  geom_point(size = 3) + 
  scale_colour_manual(values = col_vector, labels = name_vector) + 
  scale_linetype_manual(values = line_vector, labels = name_vector) + 
...
# Save figure.
ggsave("./data_application/figures/output/A3_fctstr_fdim3_kneip.png", dpi = 600, width = 20, height = 20)
