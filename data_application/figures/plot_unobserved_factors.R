...
ggsave("./data_application/figures/output/03_fctstr_fdim3_bai.png", dpi = 600, width = 10, height = 20)
...
ggsave("./data_application/figures/output/04_fctstr_fdim2_bai.png", dpi = 600, width = 10, height = 20)
...
ggsave("./data_application/figures/output/A2_fctstr_fdim3_kneip.png", dpi = 600, width = 10, height = 20)
...
ggsave("./data_application/figures/output/A3_fctstr_fdim2_kneip.png", dpi = 600, width = 10, height = 20)
